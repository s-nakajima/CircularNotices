<?php
/**
 * View/Elements/CircularNotices/choice_edit_formのテスト
 *
 ...
 *
 * @author Masaki Goto <go8ogle@gmail.com>
 * @package NetCommons\CircularNotices\Test\Case\View\Elements\CircularNotices\ChoiceEditForm
 */
class CircularNoticesViewElementsCircularNoticesChoiceEditFormTest extends NetCommonsControllerTestCase {
 ...
 */
	public function setUp() {
		...
		//テストコントローラ生成
		$this->generateNc('TestCircularNotices.TestViewElementsCircularNoticesChoiceEditForm');
	}
