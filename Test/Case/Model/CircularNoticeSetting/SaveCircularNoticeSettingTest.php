<?php
/**
 * CircularNoticeSetting::saveCircularNoticeSetting()のテスト
 *
 ...
 */
class CircularNoticeSettingSaveCircularNoticeSettingTest extends NetCommonsSaveTest {
 ...
 * @var string
 */
	protected $_methodName = 'saveCircularNoticeSetting';
