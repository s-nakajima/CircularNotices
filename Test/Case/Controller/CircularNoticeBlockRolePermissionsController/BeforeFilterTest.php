<?php
/**
 * CircularNoticeBlockRolePermissionsController::beforeFilter()のテスト
 *
 ...
 */
class CircularNoticeBlockRolePermissionsControllerBeforeFilterTest extends NetCommonsControllerTestCase {
