<?php
/**
 * CircularNoticeFrameSettingsController::beforeFilter()のテスト
 *
 ...
 */
class CircularNoticeFrameSettingsControllerBeforeFilterTest extends NetCommonsControllerTestCase {
