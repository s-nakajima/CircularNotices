<?php
class Addcolomuns extends CakeMigration {
 ...
 * @var string
 */
	public $description = 'addcolomuns';
...
e.g.) 0, 1, 5, 10'),
		...
		'down' => array(
			'drop_table' => array(
				'access_counter_frame_settings', 'access_counters', 'announcements', 'block_role_permissions', 'blocks', 'boxes', 'boxes_pages', 'containers', 'containers_pages', 'default_role_permissions', 'faq_categories', 'faq_category_orders', 'faq_frame_settings', 'faq_orders', 'faqs', 'frames', 'groups', 'groups_languages', 'groups_users', 'iframe_frame_settings', 'iframes', 'languages', 'languages_pages', 'pages', 'plugins', 'plugins_roles', 'plugins_rooms', 'roles', 'roles_rooms', 'roles_rooms_users', 'roles_user_attributes', 'room_role_permissions', 'room_roles', 'rooms', 'rss_reader_frame_settings', 'rss_readers', 'site_settings', 'spaces', 'user_attributes', 'user_attributes_users', 'user_select_attributes', 'user_select_attributes_users', 'users'
			),
			'drop_field' => array(
