 ...
 */
	public $migration = array(
		'up' => array(
			'create_table' => array(
				'circular_notice_choices' => array(
					...
					'key' => array('type' => 'string', 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'cerculat notice choices key | 回覧選択肢キー | Hash値 | ', 'charset' => 'utf8'),
		...
		'down' => array(
			'drop_table' => array(
				'circular_notice_choices', 'circular_notice_contents', 'circular_notice_frame_settings', 'circular_notice_target_users', 'circular_notices'
			),
		),
	);
